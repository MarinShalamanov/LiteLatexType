...
(function() {
  var Atom, BinaryOperator, Block, Term, UnaryOperator, extractBrackets, handleFractions, isLetter, isNumber, proccess, tokenize,
  ...
  BinaryOperator = (function(superClass) {
    ...
    function BinaryOperator(operator, val1, val2) {
      this.operator = operator;
      this.val1 = val1;
      this.val2 = val2;
      this.toString = bind(this.toString, this);
    ...
    BinaryOperator.prototype.toString = function() {
      var ref;
      if ((ref = this.operator) === '^' || ref === '_' || ref === '+' || ref === '-' || ref === '*') {
        return "" + (this.val1.toString()) + this.operator + (this.val2.toString());
      }
      return "\\" + (this.operator.toString()) + "{" + this.val1 + "}{" + (this.val2.toString()) + "}";
    };
